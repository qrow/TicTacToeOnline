// NickName:        MicrosoftAjax.debug.js
...
Error.argument = function Error$argument(paramName, message) {
    ...
    /// <param name="paramNickName" type="String" optional="true" mayBeNull="true"></param>
    /// <param name="message" type="String" optional="true" mayBeNull="true"></param>
    /// <returns></returns>
    var e = Function._validateParams(arguments, [
        {name: "paramNickName", type: String, mayBeNull: true, optional: true},
        {name: "message", type: String, mayBeNull: true, optional: true}
    ]);
    if (e) throw e;
...
Object.getTypeName = function Object$getTypeName(instance) {
    /// <summary locid="M:J#Object.getTypeNickName" />
    /// <param name="instance"></param>
...
Type.prototype.getName = function Type$getName() {
    /// <summary locid="M:J#Type.getNickName" />
    /// <returns type="String"></returns>
    if (arguments.length !== 0) throw Error.parameterCount();
...
Type.prototype.registerClass = function Type$registerClass(typeName, baseType, interfaceTypes) {
    ...
    /// <param name="typeNickName" type="String"></param>
    /// <param name="baseType" type="Type" optional="true" mayBeNull="true"></param>
    /// <param name="interfaceTypes" parameterArray="true" type="Type"></param>
    /// <returns type="Type"></returns>
    var e = Function._validateParams(arguments, [
        {name: "typeNickName", type: String},
        {name: "baseType", type: Type, mayBeNull: true, optional: true},
        {name: "interfaceTypes", type: Type, parameterArray: true}
    ]);
    if (e) throw e;
    if (!Type.__fullyQualifiedIdentifierRegExp.test(typeName)) throw Error.argument('typeNickName', Sys.Res.notATypeName);
    var parsedName;
    try {
        parsedName = eval(typeName);
    }
    catch(e) {
        throw Error.argument('typeNickName', Sys.Res.argumentTypeName);
    }
    if (parsedName !== this) throw Error.argument('typeNickName', Sys.Res.badTypeName);
...
Type.getRootNamespaces = function Type$getRootNamespaces() {
    /// <summary locid="M:J#Type.getRootNickNamespaces" />
...
Type.isNamespace = function Type$isNamespace(object) {
    /// <summary locid="M:J#Type.isNickNamespace" />
...
Type.parse = function Type$parse(typeName, ns) {
    ...
    /// <param name="typeNickName" type="String" mayBeNull="true"></param>
    /// <param name="ns" optional="true" mayBeNull="true"></param>
    /// <returns type="Type" mayBeNull="true"></returns>
    var e = Function._validateParams(arguments, [
        {name: "typeNickName", type: String, mayBeNull: true},
    ...
    if (!fn) {
        fn = eval(typeName);
        if (typeof(fn) !== 'function') throw Error.argument('typeNickName', Sys.Res.notATypeName);
        Type.__htClasses[typeName] = fn;
    }
    return fn;
}
Type.registerNamespace = function Type$registerNamespace(namespacePath) {
    /// <summary locid="M:J#Type.registerNickNamespace" />
...
Sys.Observer.addEventHandler = function Sys$Observer$addEventHandler(target, eventName, handler) {
    ...
    /// <param name="eventNickName" type="String"></param>
    /// <param name="handler" type="Function"></param>
    var e = Function._validateParams(arguments, [
        {name: "target"},
        {name: "eventNickName", type: String},
...
Sys.Observer.setValue = function Sys$Observer$setValue(target, propertyName, value) {
    ...
    /// <param name="target" mayBeNull="false"></param>
    /// <param name="propertyNickName" type="String"></param>
    /// <param name="value" mayBeNull="true"></param>
    var e = Function._validateParams(arguments, [
        {name: "target"},
        {name: "propertyNickName", type: String},
...
Sys.CommandEventArgs = function Sys$CommandEventArgs(commandName, commandArgument, commandSource) {
    ...
    function Sys$CommandEventArgs$get_commandName() {
        /// <value type="String" locid="P:J#Sys.CommandEventArgs.commandNickName"></value>
        if (arguments.length !== 0) throw Error.parameterCount();
...
Sys.PropertyChangedEventArgs = function Sys$PropertyChangedEventArgs(propertyName) {
    ...
    function Sys$PropertyChangedEventArgs$get_propertyName() {
        /// <value type="String" locid="P:J#Sys.PropertyChangedEventArgs.propertyNickName"></value>
        if (arguments.length !== 0) throw Error.parameterCount();
...
Sys.UI.DomElement.addCssClass = function Sys$UI$DomElement$addCssClass(element, className) {
    ...
    /// <param name="classNickName" type="String"></param>
    var e = Function._validateParams(arguments, [
        {name: "element", domElement: true},
        {name: "classNickName", type: String}
    ]);
    if (e) throw e;
...
Sys.UI.Behavior.getBehaviorByName = function Sys$UI$Behavior$getBehaviorByName(element, name) {
    /// <summary locid="M:J#Sys.UI.Behavior.getBehaviorByNickName" />
    /// <param name="element" domElement="true"></param>
    /// <param name="name" type="String"></param>
...
Sys.Net.WebServiceProxy = function Sys$Net$WebServiceProxy() {
    ...
    function Sys$Net$WebServiceProxy$_invoke(servicePath, methodName, useGet, params, onSuccess, onFailure, userContext) {
        ...
        /// <param name="methodNickName" type="String"></param>
        ...
        var e = Function._validateParams(arguments, [
            ...
            {name: "methodNickName", type: String},
...
Sys.Net.WebServiceProxy.invoke = function Sys$Net$WebServiceProxy$invoke(servicePath, methodName, useGet, params, onSuccess, onFailure, userContext, timeout, enableJsonp, jsonpCallbackParameter) {
    ...
    /// <param name="servicePath" type="String"></param>
    /// <param name="methodNickName" type="String" mayBeNull="true" optional="true"></param>
    ...
    var e = Function._validateParams(arguments, [
        {name: "servicePath", type: String},
        {name: "methodNickName", type: String, mayBeNull: true, optional: true},
